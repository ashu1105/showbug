	...
	<div style="margin-top: 55px;">
		...
		<div style="background-color: grey; position: absolute;top: 448px; width: 100%;">
			<div style="font-size: 25px; font-style: italic; margin-left: 325px;padding-top: 10px;padding-bottom: 10px;" >
				...
				<?php
				$q0 = "SELECT * FROM LikeDislike WHERE U_ID = ".$uid." and Show_ID = ".$ID."";
				$r0 = $con->query($q0); 

				
				?>
				
				<a style="margin-right: 50px; float: right;" href="Unliked.php?v1=<?php echo $uid; ?>&v2=<?php echo $ID; ?>" class="btn btn-2-primary">
					<span class="glyphicon glyphicon-thumbs-down"></span> Dislike
				</a>		
				<a style="margin-right: 50px; float: right;" href="Like.php?v1=<?php echo $uid; ?>&v2=<?php echo $ID; ?>" class="btn btn-2-primary">
